...
export const projects: Project[] = [
  ...
  },
  {
    ...
    featured: true,
    order: 3,
    tagline: 'A blueprint-precision redesign concept for a 1983 reprographer.',
    description:
      'A spec-pitch redesign — not adopted — for a Sonoma County reprographics shop operating since 1983: a dark, cyanotype-inspired “Blueprint Precision” system with technical grids and pen-plotter line animations, built as a zero-dependency static site with no build step.',
    longDescription: [
      'DrafTech is a large-format print and reprographics shop — two locations, in business since 1983 — that I pitched a redesign to speculatively. The design leans into the subject: a dark cyanotype palette, drafting-grid backgrounds, pen-plotter line-draw animations, and monospace technical labels, warmed by a single amber call-to-action. The owner went with another vendor; this repo never went live.',
    ...
    role: 'Designer & front-end developer (spec pitch)',
    year: '2026',
    ...
    media: [
      {
        ...
        alt: 'DrafTech Blueprinting redesign concept homepage',
        frame: 'browser',
        aspect: '16/10',
      },
    ],
