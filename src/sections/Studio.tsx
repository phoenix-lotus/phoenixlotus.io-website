...
const offers = [
  {
    ...
    body: 'The design, the words, and the behind-the-scenes details that tell Google and AI assistants what kind of business you are — built to work for everyone, on any phone. A real site, made for your trade — not a template with your name dropped into it.',
    to: '/process',
  ...
  },
  {
    ...
    body: 'Hosting, security updates, content changes when you need them, and a monthly health report — so nothing quietly breaks or goes stale while nobody’s watching.',
    to: '/services',
    cta: 'See the plans',
  },
  {
    ...
    body: 'Your Google listing set up properly and kept current, your business listed correctly across the directories that matter, and — if you want it — the social posting on top. Priced in public, not on a call.',
    to: '/services',
    cta: 'See the prices',
  },
] as const
